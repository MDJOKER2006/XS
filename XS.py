...
logo=""                                                 
   `7MMF' .g8""8q. `7MMF' `YMM' `7MM"""YMM  `7MM"""Mq.  
     MM .dP'    `YM. MM   .M'     MM    `7    MM   `MM. 
     MM dM'      `MM MM .d"       MM   d      MM   ,M9  
     MM MM        MM MMMMM.       MMmmMM      MMmmdM9   
     MM MM.      ,MP MM  VMA      MM   Y  ,   MM  YM.   
(O)  MM `Mb.    ,dP' MM   `MM.    MM     ,M   MM   `Mb. 
 Ymmm9    `"bmmd"' .JMML.   MMb..JMMmmmmMMM .JMML. .JMM. 
"""
...
def main():
    ...
    code=random.choice(["+9377","+9378","+9370"])
